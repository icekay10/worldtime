...
const CountryCard = ({ country, name, season, currentTime }) => {
...
const DayNightTracker = () => {
  ...
  return (
    <div className={styles.dayNightTracker}>
      <header className={styles.header}>
        <h1 className={styles.heroTitle}>Day & Night Tracker</h1>
        <p className={styles.heroSubtitle}>
          Track real-time day/night cycles, sunrise, sunset, and countdowns for up to 12 countries
        </p>
      </header>
      ...
      <div className={styles.controls}>
        ...
        {selectedCountries.length > 0 && (
          <p className={styles.trackingCount}>
            Tracking {selectedCountries.length} of 12 countries
          </p>
        )}
      </div>
      ...
      {selectedCountries.length > 0 ? (
        ...
        <div className={styles.emptyState}>
          ...
          <h3 className={styles.emptyTitle}>Search to Track Countries</h3>
          <p className={styles.emptyText}>Start by searching for countries above</p>
        </div>
      )}
    </div>
  );
